...
<img src="p8105_hw3_nn2477_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />
...
``` r
ggplot(mims_df, aes(x = sex, y = age)) + 
  geom_boxplot() + 
...
<img src="p8105_hw3_nn2477_files/figure-gfm/unnamed-chunk-13-1.png" width="90%" />
